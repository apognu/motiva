...
#[instrument(skip_all)]
pub async fn get_related_entities(AppState { es, .. }: &AppState, root: Option<&String>, values: &[String], negatives: &HashSet<String, RandomState>) -> anyhow::Result<Vec<EsEntity>> {
