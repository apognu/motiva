...
mod tests {
  ...
  fn extensive_entity_matching_test() {
    ...
    let queries = vec![
      se("Person").properties(&[("name", &["John Fitzgerald Kennedy"]), ("country", &["us"])]).call(),
      se("Person").properties(&[("name", &["Владимир Путин"]), ("gender", &["male"])]).call(),
      se("Person").properties(&[("name", &["محمد بن سلمان آل سعود"]), ("name", &["MBS"])]).call(),
      se("Person").properties(&[("name", &["Barak Obama"]), ("country", &["us"])]).call(),
      se("Person").properties(&[("name", &["Angela Merkel"]), ("gender", &["male"]), ("country", &["de"])]).call(),
      se("Person").properties(&[("name", &["Einstein"])]).call(),
      se("Person").properties(&[("name", &["Frida Kahlo"]), ("birthDate", &["1907"])]).call(),
      se("Person").properties(&[("name", &["The Rock"]), ("gender", &["male"])]).call(),
      se("Person").properties(&[("name", &["Osama bin Laden"]), ("name", &["Usama bin Mohammed bin Awad bin Ladin"])]).call(),
      se("Person").properties(&[("name", &["Yassir Arafat"]), ("country", &["ps"])]).call(),
      se("Person").properties(&[("name", &["Xi Jinping"]), ("country", &["cn"])]).call(),
      se("Person").properties(&[("name", &["J. R. R. Tolkien"]), ("birthDate", &["1892-01-03"])]).call(),
      se("Person").properties(&[("name", &["Sherlock Holmes"]), ("nationality", &["gb"])]).call(),
      se("Person").properties(&[("name", &["Marie Curie"]), ("gender", &["male"]), ("birthDate", &["1900"])]).call(),
      se("Person").properties(&[("name", &["Ford"])]).call(),
      se("Company").properties(&[("name", &["Apple Inc."]), ("leiCode", &["HWUPKR0MPOU8FGXBT394"])]).call(),
      se("Company").properties(&[("name", &["Сбербанк"]), ("innCode", &["7707083893"])]).call(),
      se("Company").properties(&[("name", &["Gooogle LLC"]), ("leiCode", &["5493001KJTIIGC8Y1R12"])]).call(),
      se("Company").properties(&[("name", &["Microsoft Corporation"]), ("leiCode", &["THIS-IS-WRONG"])]).call(),
      se("Company").properties(&[("name", &["IBM"]), ("country", &["us"])]).call(),
      se("Company").properties(&[("ogrnCode", &["1027700067328"])]).call(),
      se("Company").properties(&[("name", &["General Electric"])]).call(),
      se("Company").properties(&[("name", &["株式会社日立製作所"])]).call(),
      se("Company").properties(&[("name", &["Enron Corp."]), ("country", &["us"])]).call(),
      se("Company").properties(&[("name", &["Gazprom PAO"]), ("country", &["ru"])]).call(),
      se("Company").properties(&[("name", &["Rosneft"]), ("innCode", &["7706107510"]), ("leiCode", &["WRONG-LEI"])]).call(),
      se("Company").properties(&[("name", &["Berkshire Hathaway"]), ("leiCode", &["5493003G524S322TA861"])]).call(),
      se("Company").properties(&[("name", &["The Coca-Cola Company (Global)"])]).call(),
      se("Company").properties(&[("name", &["Toyota Motor"]), ("taxNumber", &["1201040105787"])]).call(),
      se("Company").properties(&[("name", &["Global Trade Solutions Ltd"])]).call(),
      se("Vessel").properties(&[("name", &["Ever Given"]), ("imoNumber", &["9811000"])]).call(),
      se("Vessel").properties(&[("name", &["Queen Mary 2"])]).call(),
      se("Vessel").properties(&[("imoNumber", &["IMO9241061"])]).call(),
      se("Vessel").properties(&[("mmsi", &["311000538"])]).call(),
      se("Vessel").properties(&[("name", &["Titnic"]), ("imoNumber", &["491414"])]).call(),
      se("Vessel").properties(&[("name", &["Symphony of the Seas"]), ("imoNumber", &["0000000"])]).call(),
      se("Vessel").properties(&[("name", &["Seawise Giant"])]).call(),
      se("Vessel")
        .properties(&[("name", &["CMA CGM Jacques Saadé"]), ("imoNumber", &["9839179"]), ("mmsi", &["228403000"])])
        .call(),
      se("Address").properties(&[("full", &["1600 Pennsylvania Avenue NW, Washington, D.C. 20500, USA"])]).call(),
      se("Address").properties(&[("full", &["10 Downing St, London, UK"])]).call(),
      se("Address").properties(&[("full", &["221B Baker Stret, London"])]).call(),
      se("Address").properties(&[("full", &["الكرملين، موسكو، روسيا، 103132"])]).call(),
      se("Address").properties(&[("full", &["Eiffel Tower, Paris"])]).call(),
      se("Address").properties(&[("full", &["Apartment 42, 1 Hacker Way, Menlo Park, CA"])]).call(),
      se("Address").properties(&[("full", &["Wall Street, New York"])]).call(),
      se("CryptoWallet").properties(&[("publicKey", &["bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq"])]).call(),
      se("CryptoWallet").properties(&[("publicKey", &["0x742d35Cc6634C0532925a3b844Bc454e4438f44e"])]).call(),
      se("CryptoWallet").properties(&[("publicKey", &["0x742d35Cc6634C0532925a3b844Bc454e4438f44f"])]).call(),
      se("CryptoWallet").properties(&[("publicKey", &["THIS-IS-NOT-A-WALLET-ADDRESS"])]).call(),
      se("CryptoWallet").properties(&[("publicKey", &["0x12345"])]).call(),
    ];
    ...
    let candidates = vec![
      e("Person")
        ...
        .call(),
      e("Person").id("Q7747").properties(&[("name", &["Vladimir Putin"]), ("gender", &["male"]), ("country", &["ru"])]).call(),
      e("Person").id("Q3099982").properties(&[("name", &["Mohammed bin Salman"]), ("country", &["sa"])]).call(),
      e("Person").id("Q76").properties(&[("name", &["Barack Obama"]), ("birthDate", &["1961"]), ("country", &["us"])]).call(),
      e("Person")
        .id("Q567")
      ...
      e("Person")
        ...
        .call(),
      e("Person").id("Q5588").properties(&[("name", &["Frida Kahlo de Rivera"]), ("birthDate", &["1907-07-06"])]).call(),
      e("Person")
        .id("Q10738")
      ...
      e("Person")
        ...
        .call(),
      e("Person").id("Q34211").properties(&[("name", &["Yasser Arafat"]), ("country", &["ps"])]).call(),
      e("Person").id("Q15031").properties(&[("name", &["习近平"]), ("country", &["cn"])]).call(),
      e("Person").id("Q892").properties(&[("name", &["John Ronald Reuel Tolkien"]), ("birthDate", &["1892-01-03"])]).call(),
      e("Person").id("Q35610").properties(&[("name", &["Arthur Conan Doyle"]), ("nationality", &["gb"])]).call(),
      e("Person")
        .id("Q7186")
        .properties(&[("name", &["Marie Skłodowska Curie"]), ("gender", &["female"]), ("birthDate", &["1867-11-07"])])
        .call(),
      e("Person").id("Q82333").properties(&[("name", &["Henry Ford"]), ("gender", &["male"])]).call(),
      e("Company")
        .id("NK-aV5xM")
      ...
      e("Company")
        ...
        .call(),
      e("Company").id("NK-2aZ5h").properties(&[("name", &["Google LLC"]), ("leiCode", &["5493001KJTIIGC8Y1R12"])]).call(),
      e("Company")
        .id("NK-fS7uW")
      ...
      e("Company")
        ...
        .call(),
      e("Company").id("NK-mN5yR").properties(&[("name", &["Hitachi, Ltd."]), ("country", &["jp"])]).call(),
      e("Company").id("NK-yH2wD").properties(&[("name", &["Chevron Corporation"]), ("country", &["us"])]).call(),
      e("Company")
        .id("NK-pB6gX-2")
      ...
      e("Company")
        ...
        .call(),
      e("Company").id("NK-aF4xP").properties(&[("name", &["The Coca-Cola Company"]), ("country", &["us"])]).call(),
      e("Company")
        .id("NK-uL7iQ")
        .properties(&[("name", &["Toyota Motor Corporation"]), ("leiCode", &["549300P4B9R13GCSL880"]), ("country", &["jp"])])
        .call(),
      e("Company").id("NK-bH5zK").properties(&[("name", &["Maersk Line"]), ("country", &["dk"])]).call(),
      e("Vessel").id("Q65063544").properties(&[("name", &["Ever Given"]), ("imoNumber", &["IMO9811000"])]).call(),
      e("Vessel").id("Q502933").properties(&[("name", &["RMS Queen Mary 2"]), ("imoNumber", &["IMO9241061"])]).call(),
      e("Vessel").id("Q502933-2").properties(&[("name", &["APL England"])]).call(),
      e("Vessel").id("Q60775394").properties(&[("name", &["Wonder of the Seas"]), ("mmsi", &["311000538"])]).call(),
      e("Vessel").id("Q25173").properties(&[("name", &["RMS Titanic"]), ("imoNumber", &["491414"])]).call(),
      e("Vessel").id("Q28404283").properties(&[("name", &["Symphony of the Seas"]), ("imoNumber", &["9744001"])]).call(),
      e("Vessel").id("Q642392").properties(&[("name", &["Knock Nevis"]), ("pastName", &["Seawise Giant"])]).call(),
      e("Vessel")
        .id("Q65087796")
        .properties(&[("name", &["CMA CGM Jacques Saadé"]), ("imoNumber", &["9839179"]), ("mmsi", &["228403000"])])
        .call(),
      e("Address")
        ...
        .call(),
      e("Address").id("ADDR_UK_DS").properties(&[("full", &["10 Downing Street, London, SW1A 2AA, United Kingdom"])]).call(),
      e("Address").id("ADDR_UK_BH").properties(&[("full", &["221B Baker Street, London"])]).call(),
      e("Address").id("ADDR_RU_KR").properties(&[("full", &["Moscow Kremlin, Moscow, Russia, 103132"])]).call(),
      e("Address")
        .id("ADDR_FR_ET")
        .properties(&[("full", &["Champ de Mars, 5 Avenue Anatole France, 75007 Paris, France"])])
        .call(),
      e("Address").id("ADDR_US_FB").properties(&[("full", &["1 Hacker Way, Menlo Park, CA 94025, USA"])]).call(),
      e("Address").id("ADDR_US_WS").properties(&[("full", &["11 Wall Street, New York, NY 10005, USA"])]).call(),
      e("CryptoWallet")
        .id("BTC_DONATE_1")
      ...
      e("CryptoWallet")
        ...
        .call(),
      e("CryptoWallet").id("BTC_SATOSHI_GEN").properties(&[("publicKey", &["1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"])]).call(),
      e("CryptoWallet").id("XRP_RANDOM_1").properties(&[("publicKey", &["rEb8TK3gBgk5oZkwcONkWIb4n57_w4Xhnp"])]).call(),
    ];
